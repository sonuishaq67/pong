...
class Model(nn.Module):
    def __init__(self, action_dim, hidden_dim=256, observation_shape=None):
        ...
        # Larger CNN for better feature extraction (standard DQN architecture)
...
def soft_update(target, source, tau=0.01):
    # tau=0.01 for faster convergence with large batch training
    # Equivalent to hard update every ~100 steps (1/tau)
